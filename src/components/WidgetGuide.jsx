...
function buildScript(deadlineMs, accent) {
  return [
    ...
    '',
    'w.addSpacer()   // ดันเนื้อหาให้กึ่งกลางแนวตั้ง',
    '',
    '// แถววันที่ (จัดกึ่งกลางแนวนอนด้วย spacer สองข้าง)',
    'const dRow = w.addStack(); dRow.addSpacer()',
    'const dateT = dRow.addText(dateStr)',
    'dateT.font = Font.mediumSystemFont(22)',
    'dateT.textColor = new Color(ACCENT)',
    'dateT.centerAlignText()',
    ...
    'w.addSpacer(2)',
    '',
    '// แถวเวลา ตัวใหญ่ เดินสด (จัดกึ่งกลาง)',
    'const tRow = w.addStack(); tRow.addSpacer()',
    'const timer = tRow.addDate(boundary)',
    'timer.applyTimerStyle()          // ชม:นาที:วิ เดินสดทุกวินาที',
    'timer.font = Font.boldMonospacedSystemFont(54)',
    'timer.textColor = new Color(ACCENT)',
    'timer.centerAlignText()          // จัดตัวเลขให้อยู่กลางกล่อง (กันเอียงซ้าย)',
    'timer.shadowColor = new Color(ACCENT, 0.55)',
    'timer.shadowRadius = 12',
    'tRow.addSpacer()',
    '',
    'w.addSpacer(4)',
    '',
    'const sRow = w.addStack(); sRow.addSpacer()',
    'const sub = sRow.addText("\\u0E40\\u0E27\\u0E25\\u0E32\\u0E0A\\u0E35\\u0E27\\u0E34\\u0E15\\u0E04\\u0E07\\u0E40\\u0E2B\\u0E25\\u0E37\\u0E2D")',
    'sub.font = Font.systemFont(11)',
    'sub.textColor = new Color("#4a7a56")',
    'sub.centerAlignText()',
    'sRow.addSpacer()',
    '',
    'w.addSpacer()   // จัดกึ่งกลางแนวตั้ง',
    '',
